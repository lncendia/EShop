...
namespace EShop.Authentication.Services.Commands.Password;

/// <summary>
/// Обработчик для выполнения команды сброса пароля
/// </summary>
/// <param name="userManager">Менеджер пользователей, предоставленный ASP.NET Core Identity.</param>
public class RecoverPasswordCommandHandler(UserManager<User> userManager) : IRequestHandler<RecoverPasswordCommand>
{
    /// <summary>
