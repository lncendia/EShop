...
public class EmailContentVisitor(EmailTemplateConfiguration configuration) : IEmailVisitor
{
    /// <summary>
    ...
    public void Visit(ConfirmRegistrationEmail email)
    {
        ...
        const string text = "Подтвердите свой адрес электронной почты, нажав на кнопку ниже. Этот шаг повышает безопасность вашего бизнеса, подтверждая, что вы являетесь владельцем этого почтового адреса.";

        // Создаем переменную explanation и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailExplanation"
        const string explanation = "Вы получили это письмо, потому что недавно зарегистрировали учетную запись.";

        // Создаем переменную buttonName и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailButtonName"
        const string buttonName = "Подтвердить регистрацию";

        // Создаем переменную expiration и устанавливаем значение из локализатора "LinkExpires"
        const string expiration = "Ссылка истекает через 24 часа после получения письма.";

        // Вызываем метод EmailTemplate и присваиваем результат переменной HtmlContent
        HtmlContent = EmailTemplate(Subject, explanation, text, ButtonTemplate(buttonName, email.ConfirmLink), expiration, email.Recipient);
    }
    ...
    public void Visit(ConfirmRecoverPasswordEmail email)
    {
        ...
        // Создаем переменную text и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailText"
        const string text = "Подтвердите сброс старого пароля, нажав на кнопку ниже. Этот шаг удалит ваш старый пароль и позволит вам установить новый.";

        // Создаем переменную explanation и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailExplanation"
        const string explanation = "Вы получили это письмо, потому что запросили восстановление своего пароля.";

        // Создаем переменную buttonName и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailButtonName"
        const string buttonName = "Восстановить пароль";
    ...
    public void Visit(ConfirmMailChangeEmail email)
    {
        ...
        // Создаем переменную text и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailText"
        const string text = "Подтвердите смену своего адреса электронной почты на новый нажав на кнопку ниже.";

        // Создаем переменную explanation и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailExplanation"
        const string explanation = "Вы получили это письмо, потому что запросили смену адреса электронной почты.";

        // Создаем переменную buttonName и задаем ей значение из локализатора, используя ключ "ConfirmRegistrationEmailButtonName"
        const string buttonName = "Изменить почту";
                                                                  ...
                                                                  <table cellpadding="0" cellspacing="0" width="100%"
                                                                      ...
                                                                      <tr>
                                                                          <td align="left" style="padding:0;Margin:0"><p
                                                                             ...
                                                                             Благодарим,<br><br>{{configuration.CompanyName}}</p></td>
                                                                      </tr>
                                                                      <tr>
                                                                          <td align="center"
                                                                      ...
                                                                      <tr>
                                                                          <td align="center" style="padding:0;Margin:0"><p
                                                                              ...
                                                                              <a target="_blank"
                                                                                 ...
                                                                                 href="{{configuration.PrivatePolicyLink}}">Политика конфиденциальности</a>
                                                                      </tr>
                                                                      <tr>
                                                                          <td align="center"
